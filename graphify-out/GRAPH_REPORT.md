# Graph Report - stock-intelligence-test-1-vs  (2026-07-12)

## Corpus Check
- 156 files · ~1,391,304 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2285 nodes · 3369 edges · 165 communities detected
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 452 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8fb9d3df`
...
Cohesion: 0.11
Nodes (21): Breadcrumb: Current Week > India > Nifty 50, Weekly Returns All Stocks Bar Chart, Stock Search Feature, Nifty 50 Group, India Market, 49 Stocks Tracked Label, Indian Market (NSE/BSE), Reliance Industries Search Result (+13 more)
...
Cohesion: 0.14
Nodes (11): envelope(), SEBI envelope helper — wraps every API response.  Single source of truth for seb, Wrap data in the standard SEBI envelope.      Every endpoint must return this st, accuracy_state(), GET /accuracy — accuracy ledger summary.  Delegates to src/pages/accuracy.py for, health(), GET /health — liveness + data presence gate.  ohlcv_rows > 0 is required for Ses, market_data() (+3 more)
...
- **Why does `Exception` connect `Community 7` to `Community 35`, `Community 4`, `Community 28`?**
  _High betweenness centrality (0.058) - this node is a cross-community bridge._
- **Why does `get_supabase_client()` connect `Community 59` to `Community 66`, `Community 35`, `Community 7`, `Community 73`, `Community 75`, `Community 76`, `Community 53`, `Community 87`, `Community 89`, `Community 28`?**
