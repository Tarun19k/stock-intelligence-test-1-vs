# Graph Report - stock-intelligence-test-1-vs  (2026-06-27)

## Corpus Check
- 117 files · ~1,368,147 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2158 nodes · 3223 edges · 152 communities detected
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 428 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `341bb747`
...
Cohesion: 0.05
Nodes (36): _detect_circuit_flag(), download_bhavcopy_nse(), get_ingest_staleness_flag(), parse_bhavcopy_nse(), NSE/BSE Bhavcopy download and parse.  Bhavcopy is NSE/BSE's daily end-of-day pri, Proxy circuit detection: H == L == C > 0 indicates a locked-price bar.      NSE, Parse NSE Bhavcopy CSV text into OHLCV row dicts.      Only rows with SERIES in, Classify ingest freshness for the Imran SRA staleness banner.      Returns: (+28 more)
...
Cohesion: 0.04
Nodes (57): Refresh Data Button, App Version v5.36, Refresh Data Button, Commodities & Global Inflation, Compare Tab, Open Dashboard Button CTA, Start Analysing Free Right Now CTA, Dark Theme UI (+49 more)
...
Cohesion: 0.06
Nodes (42): Stress Regime Detected Alert Banner, Daily Return Axis (y-axis), Daily Volatility Axis (x-axis), Risk Profile Selector (Conservative / Balanced / Aggressive), 4-Tab Stock Dashboard Feature, Forecast Tracker Feature, Global Intelligence Feature, Live Ticker Bar Feature (+34 more)
...
Cohesion: 0.1
Nodes (41): Bug: Static Text with Delay Load, Crude WTI, Gold ($4,685), USD/INR, Global Trend Signals, Bank Nifty, DOW JONES, Dow Jones (46,403 -0.xx%) (+33 more)
...
Cohesion: 0.1
Nodes (32): GSI Dashboard v5.36, Multi-Asset Weekly Performance Bar Chart, Multi-Asset Weekly Return Bar Chart, Crude Oil WTI ($115), Week of 06 Apr – 07 Apr 2026 (current week), Current Week Market View, USD/INR: 92.85 (+0.13%), USD/INR Exchange Rate (+24 more)
...
Cohesion: 0.14
Nodes (14): get_staleness_banner(), Data viewer page — OHLCV and fundamentals display.  Varghese condition: PAGE_REQ, Streamlit render entry point — called by app.py navigation., Query ingest_status and return a banner string if data is stale or missing., Query ingest_status and return a banner string if data is stale or missing., Streamlit render entry point — called by app.py navigation., Streamlit render entry point — called by app.py navigation., render() (+6 more)
...
Cohesion: 0.17
Nodes (12): get_proposed_weights_count(), get_proposed_weights_summary(), Accuracy ledger page — signal hit-rate and PROPOSED weight review.  Munger condi, Return count of signal_weights rows in PROPOSED status.     Delegates to signals, Return a summary dict of pending PROPOSED weights for the accuracy tab UI., Streamlit render entry point — called by app.py navigation., Return a summary dict of pending PROPOSED weights for the accuracy tab UI., Streamlit render entry point — called by app.py navigation. (+4 more)
...
Cohesion: 0.22
Nodes (9): get_disclaimer_html(), main(), AlphaVeda — Streamlit entry point.  SEBI disclaimer (Varghese): injected via get, Return the fixed-bottom SEBI disclaimer HTML block.      Always returns the full, Return the fixed-bottom SEBI disclaimer HTML block.      Always returns the full, Streamlit app entry point., Streamlit app entry point., Disclaimer HTML contains substance and no dismiss mechanism (Varghese Check 7). (+1 more)
...
Cohesion: 0.4
Nodes (5): get_cold_start_label(), Return cold-start label when segment_obs < OBSERVATION_THRESHOLD, else None., Cold-start label is returned when segment_obs < OBSERVATION_THRESHOLD., Cold-start label is returned when segment_obs < OBSERVATION_THRESHOLD., test_cold_start_label_visible()
...
- **Why does `Exception` connect `Community 92` to `Community 36`, `Community 5`, `Community 48`, `Community 80`, `Community 58`?**
  _High betweenness centrality (0.084) - this node is a cross-community bridge._
- **Why does `test_is_commercial_fail_closed()` connect `Community 92` to `Community 26`, `Community 58`?**
  _High betweenness centrality (0.061) - this node is a cross-community bridge._
- **Why does `get_supabase_client()` connect `Community 109` to `Community 0`, `Community 36`, `Community 45`, `Community 79`, `Community 52`, `Community 85`, `Community 57`, `Community 58`, `Community 59`?**
