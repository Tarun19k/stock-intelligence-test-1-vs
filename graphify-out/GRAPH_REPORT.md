# Graph Report - stock-intelligence-test-1-vs  (2026-07-19)

## Corpus Check
- 161 files · ~1,425,810 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2360 nodes · 3473 edges · 167 communities detected
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 459 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ba408027`
...
Cohesion: 0.05
Nodes (45): Breadcrumb: Current Week > India > Nifty 50, Refresh Data Button, Weekly Returns All Stocks Bar Chart, Group-Level Sector Selection Feature, Stock Search Feature, Market Filter (India), Search Filter (Company Name or Symbol), Auto & EV Sector Group (+37 more)
...
Cohesion: 0.18
Nodes (8): parse_bhavcopy_nse(), Parse NSE Bhavcopy CSV text into OHLCV row dicts.      Only rows with SERIES in, Parse NSE Bhavcopy CSV text into OHLCV row dicts.      Only rows with SERIES in, Jhunjhunwala gate: proxy detects H==L==C (locked-price bar) as circuit., Jhunjhunwala gate: proxy detects H==L==C (locked-price bar) as circuit., Normal trading day (H≠L): circuit_flag must be False., Normal trading day (H≠L): circuit_flag must be False., TestParseBhavcopynse
...
Cohesion: 0.4
Nodes (4): health(), GET /health — liveness + data presence gate.  ohlcv_rows > 0 is required for Ses, get_supabase_client(), Return the module-level Supabase client, creating it once per process.
...
## Knowledge Gaps
- **941 isolated node(s):** `R-ZIP · KI-014: Re-read packaged zip from disk and run full suite.     Catches f`, `Return the forecast history dict.     Primary store: st.session_state[_SS_KEY].`, `Persist the forecast history dict.     Always writes to session_state (works on`, `Record a new forecast entry (one per ticker per day).     simulation: optional d`, `Check all pending forecasts whose due date has passed and mark them     resolved` (+936 more)
...
- **Why does `get_supabase_client()` connect `Community 114` to `Community 65`, `Community 67`, `Community 38`, `Community 73`, `Community 74`, `Community 44`, `Community 80`, `Community 81`, `Community 62`, `Community 54`, `Community 87`, `Community 120`, `Community 57`, `Community 93`, `Community 94`?**
  _High betweenness centrality (0.077) - this node is a cross-community bridge._
- **Why does `Exception` connect `Community 108` to `Community 4`, `Community 38`, `Community 44`, `Community 51`, `Community 57`, `Community 92`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `_set_rate_limited()` connect `Community 4` to `Community 108`?**
