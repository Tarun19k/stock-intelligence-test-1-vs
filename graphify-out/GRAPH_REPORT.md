# Graph Report - stock-intelligence-test-1-vs  (2026-07-13)

## Corpus Check
- 157 files · ~1,402,564 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2289 nodes · 3378 edges · 169 communities detected
- Extraction: 87% EXTRACTED · 13% INFERRED · 0% AMBIGUOUS · INFERRED: 453 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ea202316`
...
## Communities (189 total, 44 thin omitted)
...
Cohesion: 0.04
Nodes (54): Refresh Data Button, App Version v5.36, Refresh Data Button, Commodities & Global Inflation, Compare Tab, Open Dashboard Button CTA, Start Analysing Free Right Now CTA, Dark Theme UI (+46 more)
...
Cohesion: 0.07
Nodes (20): LanguageToggle(), Lex(), LexOrRaw(), ProbabilityFrame(), isCommercial(), isPersonalContext(), GlossaryProvider(), useGlossary() (+12 more)
...
Cohesion: 0.07
Nodes (12): Council Conditions Test Suite ============================== Every test is label, Bhattacharya (data licensing): licence_class and deliverable_volume must exist., Bhattacharya (data licensing): licence_class and deliverable_volume must exist., Bhattacharya (data licensing): licence_class and deliverable_volume must exist., Shakuni: Duplicate ACTIVE signal_weights per segment must be impossible., Shakuni: Duplicate ACTIVE signal_weights per segment must be impossible., Shakuni: Duplicate ACTIVE signal_weights per segment must be impossible., test_all_results_are_valid_phases() (+4 more)
...
Cohesion: 0.13
Nodes (21): Estimated Tokens Column, Sub-sprint Column, compliance_check.py File, .claude/commands/new-session File, regression.py File, .claude/commands/sprint-monitor File, Baseline Metric (437), Sprint Progress Metric (7/9) (+13 more)

### Community 33 - "Community 33"
Cohesion: 0.14
Nodes (21): All Risks Mitigated Status Banner, App Internals Section, App Version v5.38, Deploy Button, Compliance Gates (Live Check), Mitigated Risks Badge, App Navigation Item, Dashboard Navigation Item (+13 more)
...
Cohesion: 0.12
Nodes (19): Refresh Data Button, Market Filter (India), Search Filter (Company Name or Symbol), India Market, Indian Market (NSE/BSE), Sidebar Market Selector (India), Market CLOSED Status, Market CLOSED Badge (+11 more)
...
Cohesion: 0.23
Nodes (15): Crude WTI, Gold ($4,685), USD/INR Exchange Rate, USD/INR, Global Trend Signals, Hang Seng Index (HK$25,117), RSI + Momentum Indicator, USD (US Dollar) (+7 more)
...
Cohesion: 0.24
Nodes (11): Bug: Static Text with Delay Load, DOW JONES, Dow Jones (46,403 -0.xx%), Nasdaq (23,996 -0.81%), S&P 500 (6,576 -0.55%), US Market, S&P 500 Change -0.55%, S&P 500 Value 6,576 (+3 more)

### Community 81 - "Community 81"
Cohesion: 0.24
Nodes (11): Bank Nifty, Sensex Index (211), Indian Equities Market, Bank Nifty Change +0.20%, Bank Nifty Value 52,716, Sensex Change +0.69%, Sensex Value 74,617, CAUTION Signal (RSI + Momentum) (+3 more)
...
Cohesion: 0.33
Nodes (9): Crude Oil WTI ($115), USD/INR: 92.85 (+0.13%), Nasdaq 100 Index (24,060), Nifty 50 (2,716 +0.20%), Nifty Bank Index (52,716), India Market Region, Weekly Return Percentage, Global Ticker Bar (+1 more)
...
Cohesion: 0.33
Nodes (6): Nav Item: App, Nav Item: Dashboard, Nav Item: Global Intelligence, Nav Item: Home, Nav Item: Week Summary, Sidebar Navigation
...
## Knowledge Gaps
- **904 isolated node(s):** `R-ZIP · KI-014: Re-read packaged zip from disk and run full suite.     Catches f`, `Return the forecast history dict.     Primary store: st.session_state[_SS_KEY].`, `Persist the forecast history dict.     Always writes to session_state (works on`, `Record a new forecast entry (one per ticker per day).     simulation: optional d`, `Check all pending forecasts whose due date has passed and mark them     resolved` (+899 more)
...
- **Why does `Exception` connect `Community 106` to `Community 65`, `Community 34`, `Community 3`, `Community 52`, `Community 91`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `get_supabase_client()` connect `Community 53` to `Community 96`, `Community 65`, `Community 66`, `Community 34`, `Community 98`, `Community 73`, `Community 77`, `Community 48`, `Community 119`, `Community 86`, `Community 87`?**
  _High betweenness centrality (0.048) - this node is a cross-community bridge._
- **Why does `_set_rate_limited()` connect `Community 3` to `Community 106`?**
