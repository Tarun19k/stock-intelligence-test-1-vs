...
Cohesion: 0.1
Nodes (47): Bug: Static Text with Delay Load, Crude Oil WTI ($115), Crude WTI, Gold ($4,685), USD/INR: 92.85 (+0.13%), USD/INR Exchange Rate, USD/INR, Global Trend Signals (+39 more)
...
Cohesion: 0.1
Nodes (21): get_staleness_warning(), Return staleness warning when last_review_date is more than 90 days ago, else No, Phase 5 — Streamlit app presentation layer tests.  Design principle: pages expos, Weight review banner is returned when PROPOSED weights exist., No banner when there are no PROPOSED weights., No banner when there are no PROPOSED weights., 90-day overdue warning is shown on accuracy page., 90-day overdue warning is shown on accuracy page. (+13 more)
...
Cohesion: 0.14
Nodes (15): CustomLogger, Exception, ApprovalLayer, _classify(), _macos_approve(), _osascript(), Run an AppleScript snippet and return (stdout, returncode)., Show a native macOS dialog. Returns (choice, alt_model).     choice: "approve" | (+7 more)
...
Cohesion: 0.12
Nodes (12): envelope(), SEBI envelope helper — wraps every API response.  Single source of truth for seb, Wrap data in the standard SEBI envelope.      Every endpoint must return this st, accuracy_state(), GET /accuracy — accuracy ledger summary.  Delegates to src/pages/accuracy.py for, health(), GET /health — liveness + data presence gate.  ohlcv_rows > 0 is required for Ses, market_data() (+4 more)
...
Cohesion: 0.2
Nodes (10): calibrate_confidence(), Map raw confidence to calibrated probability p ∈ [0.0, 1.0].      Cold-start (se, Map raw confidence to calibrated probability p ∈ [0.0, 1.0].      Cold-start (se, test_cold_start_calibration_p_leq_confidence(), Calibrated p must never exceed confidence/100 in cold-start., Warm path (>= OBSERVATION_THRESHOLD): p = hit_rate (capped at confidence/100)., Calibrated p must always be in [0.0, 1.0]., test_calibration_result_in_unit_interval() (+2 more)
...
- **Why does `Exception` connect `Community 46` to `Community 64`, `Community 4`, `Community 37`, `Community 43`, `Community 88`, `Community 94`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `get_supabase_client()` connect `Community 51` to `Community 64`, `Community 65`, `Community 97`, `Community 89`, `Community 96`, `Community 37`, `Community 72`, `Community 75`, `Community 43`, `Community 84`, `Community 121`?**
  _High betweenness centrality (0.047) - this node is a cross-community bridge._
- **Why does `_set_rate_limited()` connect `Community 4` to `Community 46`?**
