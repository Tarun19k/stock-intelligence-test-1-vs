...
Cohesion: 0.14
Nodes (13): CacheManager, DataResult, Bounded LRU in-memory cache (L2).      Deployment note: Streamlit-specific.  Sin, Returns DataResult if the entry exists (FRESH or STALE), None if not found., Store result.  No-op if status == UNAVAILABLE.         Evicts the LRU entry if a, Every DataManager response is a DataResult.     data is None if and only if stat, _make_result(), Unit tests for DataManager M2 — CacheManager and DataContract.  Run: pytest test (+5 more)
...
Cohesion: 0.12
Nodes (16): Phase 5 — Streamlit app presentation layer tests.  Design principle: pages expos, No banner when there are no PROPOSED weights., No banner when there are no PROPOSED weights., Path page shows weight review banner when PROPOSED weights exist., When no ingest_status rows exist, data_viewer returns the MISSING banner., When no ingest_status rows exist, data_viewer returns the MISSING banner., Path page shows weight review banner when PROPOSED weights exist., Path page shows weight review banner when PROPOSED weights exist. (+8 more)
...
Cohesion: 0.33
Nodes (4): Soros + Buffett: Arbitration suppresses when bull/bear confidence within ARBITRA, Soros + Buffett: Arbitration suppresses when bull/bear confidence within ARBITRA, Soros + Buffett: Arbitration suppresses when bull/bear confidence within ARBITRA, TestArbitrationConditions
...
Cohesion: 0.67
Nodes (3): Weight review banner is returned when PROPOSED weights exist., Weight review banner is returned when PROPOSED weights exist., test_review_banner_shown()
...
- **Why does `Exception` connect `Community 56` to `Community 96`, `Community 4`, `Community 36`, `Community 50`, `Community 89`, `Community 29`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `get_supabase_client()` connect `Community 103` to `Community 97`, `Community 36`, `Community 72`, `Community 75`, `Community 76`, `Community 114`, `Community 29`, `Community 82`, `Community 86`, `Community 56`, `Community 63`, `Community 62`, `Community 95`?**
