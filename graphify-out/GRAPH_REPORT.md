...
- Token cost: 15,855 input · 11,780 output

## Community Hubs (Navigation)
- [[_COMMUNITY_Dashboard & Market Data|Dashboard & Market Data]]
- [[_COMMUNITY_Stock Computation Engine A|Stock Computation Engine A]]
- [[_COMMUNITY_Stock Computation Engine B|Stock Computation Engine B]]
- [[_COMMUNITY_Home & Market Data Layer|Home & Market Data Layer]]
- [[_COMMUNITY_Signal Engine — Bearish|Signal Engine — Bearish]]
- [[_COMMUNITY_Dashboard UI Shell|Dashboard UI Shell]]
- [[_COMMUNITY_Portfolio Allocator|Portfolio Allocator]]
- [[_COMMUNITY_App Internals & Observability|App Internals & Observability]]
- [[_COMMUNITY_Technical Indicators|Technical Indicators]]
- [[_COMMUNITY_Compliance & Audit Pipeline|Compliance & Audit Pipeline]]
- [[_COMMUNITY_Week Summary Feature|Week Summary Feature]]
- [[_COMMUNITY_Sprint Monitor & Checks|Sprint Monitor & Checks]]
- [[_COMMUNITY_Home Screen Content|Home Screen Content]]
- [[_COMMUNITY_Risk & Compliance UI|Risk & Compliance UI]]
- [[_COMMUNITY_Week Summary Metrics|Week Summary Metrics]]
- [[_COMMUNITY_Resilience Infrastructure|Resilience Infrastructure]]
- [[_COMMUNITY_Forecast Tracker|Forecast Tracker]]
- [[_COMMUNITY_Market Status & Hours|Market Status & Hours]]
- [[_COMMUNITY_Portfolio Optimization|Portfolio Optimization]]
- [[_COMMUNITY_Cache Infrastructure|Cache Infrastructure]]
...
### Community 0 - "Dashboard & Market Data"
Cohesion: 0.06
...
### Community 1 - "Stock Computation Engine A"
Cohesion: 0.06
...
### Community 2 - "Stock Computation Engine B"
Cohesion: 0.05
...
### Community 3 - "Home & Market Data Layer"
Cohesion: 0.06
...
### Community 4 - "Signal Engine — Bearish"
Cohesion: 0.05
...
### Community 5 - "Dashboard UI Shell"
Cohesion: 0.04
...
### Community 6 - "Portfolio Allocator"
Cohesion: 0.05
...
### Community 7 - "App Internals & Observability"
Cohesion: 0.06
...
### Community 8 - "Technical Indicators"
Cohesion: 0.08
...
### Community 9 - "Compliance & Audit Pipeline"
Cohesion: 0.07
...
### Community 10 - "Week Summary Feature"
Cohesion: 0.08
...
### Community 11 - "Sprint Monitor & Checks"
Cohesion: 0.17
...
### Community 12 - "Home Screen Content"
Cohesion: 0.08
...
### Community 13 - "Risk & Compliance UI"
Cohesion: 0.08
...
### Community 14 - "Week Summary Metrics"
Cohesion: 0.07
...
### Community 15 - "Resilience Infrastructure"
Cohesion: 0.07
Nodes (17): CircuitBreaker, DataManager, get_datamanager(), Factory for UNAVAILABLE DataResult.     Use this everywhere — never construct Da, Per-source circuit breaker.  Three-state machine:          CLOSED ──(N consecuti, Returns True if a request should proceed.         CLOSED  → always True., Call after any successful fetch from this source., Call after any failed fetch from this source. (+9 more)

### Community 16 - "Forecast Tracker"
Cohesion: 0.09
...
### Community 17 - "Market Status & Hours"
Cohesion: 0.11
...
### Community 18 - "Portfolio Optimization"
Cohesion: 0.09
...
### Community 19 - "Cache Infrastructure"
Cohesion: 0.15
Nodes (7): CacheManager, Bounded LRU in-memory cache (L2).      Deployment note: Streamlit-specific.  Sin, Store result.  No-op if status == UNAVAILABLE.         Evicts the LRU entry if a, Remove all cache entries for this ticker across all DataTypes., _make_result(), TestCacheManagerHit, TestCacheManagerTTL
...
Cohesion: 0.15
Nodes (12): DataContract, DataResult, DataType, Wire-level shape validator for each DataType.      Validates that data received, Every DataManager response is a DataResult.     data is None if and only if stat, SourceTag, Unit tests for DataManager M2 — CacheManager and DataContract.  Run: pytest test, TestCacheManagerInvalidate (+4 more)
...
Cohesion: 0.19
Nodes (10): Enum, CircuitState, Priority, data_manager.py — Global Stock Intelligence Dashboard DataManager: resilient dat, ResultStatus, validate(), _validate_batch(), _validate_info() (+2 more)
...
## Knowledge Gaps
- **522 isolated node(s):** `R-ZIP · KI-014: Re-read packaged zip from disk and run full suite.     Catches f`, `Return the forecast history dict.     Primary store: st.session_state[_SS_KEY].`, `Persist the forecast history dict.     Always writes to session_state (works on`, `Record a new forecast entry (one per ticker per day).     simulation: optional d`, `Check all pending forecasts whose due date has passed and mark them     resolved` (+517 more)
...
- **Why does `GSI Dashboard` connect `Dashboard UI Shell` to `Dashboard & Market Data`, `Signal Engine — Bearish`, `Portfolio Allocator`, `App Internals & Observability`, `Home Screen Content`, `Forecast Tracker`, `Cluster 20`, `Cluster 23`, `Cluster 28`, `Cluster 34`, `Cluster 37`, `Cluster 38`, `Cluster 39`, `Cluster 40`, `Cluster 43`, `Cluster 46`, `Cluster 50`, `Cluster 51`, `Cluster 55`, `Cluster 63`, `Cluster 66`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `Nifty 50 (2,716 +0.20%)` connect `Dashboard & Market Data` to `Market Status & Hours`, `Portfolio Optimization`, `Dashboard UI Shell`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `Streamlit Application` connect `Cluster 20` to `Dashboard UI Shell`?**
...
- **Are the 24 inferred relationships involving `CacheManager` (e.g. with `TestCacheManagerMiss` and `TestCacheManagerHit`) actually correct?**
...
- **Should `Dashboard & Market Data` be split into smaller, more focused modules?**
