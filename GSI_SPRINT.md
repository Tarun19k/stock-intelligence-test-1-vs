...
|---|---|---|---|---|---|---|
| Trust Restoration | v5.41 | 4 | 1 | ~90k est | 2 parallel worktrees for TRUST-01+OPEN-012; TRUST-02/03 sequential; context compaction ~15k fixed | CL=F bounds; exchange labels; RSS swap; Weinstein label key fix; Policy 6 compliant; 480/485 |
